...
public class JedisCacheGroup<T extends JedisCacheImpl> extends ReusableObjectPool<T> {
	...
	public JedisCacheGroup(final String namePrefix, final Class<? extends JedisCacheImpl> cacheClazz, final String cacheName, final JedisConnectionFactory jedisConnectionFactory, int maxTotal, int maxIdle, int minIdle) {
	...
	public JedisCacheGroup(final String namePrefix, final Class<? extends JedisCacheImpl> cacheClazz, final String cacheName, final JedisConnectionFactory jedisConnectionFactory) {
		this(namePrefix, cacheClazz, cacheName, jedisConnectionFactory, ReusableObjectPool.OBJECT_POOL_MAX_TOTAL, ReusableObjectPool.OBJECT_POOL_MAX_IDLE, ReusableObjectPool.OBJECT_POOL_MIN_IDLE);
	...
	public T create() throws Exception {
		...
		return constructor.newInstance(JedisCacheGroup.this.namePrefix, JedisCacheGroup.this.cacheCateforyName, JedisCacheGroup.this.jedisConnectionFactory, this);
	}
