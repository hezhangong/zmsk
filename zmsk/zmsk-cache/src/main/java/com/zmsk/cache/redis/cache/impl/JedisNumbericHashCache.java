...
import com.zmsk.cache.redis.NumbericHashCache;
...
public class JedisNumbericHashCache extends JedisHashCache<String, Long> implements NumbericHashCache {
	...
	public JedisNumbericHashCache(String namePrefix, String cacheName, JedisConnectionFactory connectionFactory, ReusableObjectPool<JedisHashCache<String, Long>> objectPool) {
